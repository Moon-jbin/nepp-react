...
export const putUsersMyInfo = async (req, res) => {
  ...
  const query = `
    UPDATE user SET name = '${name}', user_name='${user_name}', memo='${memo}'
    WHERE id=${userId};
  `;
